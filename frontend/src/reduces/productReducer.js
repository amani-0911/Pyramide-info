...
export const productCategoryListReducer = (
    state = { loading: true, categories: [] },action)=>{
        switch (action.type) {
    ...
    export const productBrandListReducer = (
      state = { loading: true, brands: [] },action)=>{
          switch (action.type) {
